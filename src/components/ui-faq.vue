<template>
	<div class="ui-faq">
		<p class="ui-faq__title">{{ title }}</p>
		<ui-collapse :data="data" />
	</div>
</template>
		...
		data: {
			...
			default: () =>
				[
					...
					{
						title: "Are these achievements transferrable?",
						description:
